...
class SmartargetLine_Admin {
	...
	public function add_plugin_admin_menu() {
		...
		*/
		add_options_page( 'Smartarget Line Chat - Contact Us Settings', 'Smartarget Line Chat - Contact Us', 'manage_options', $this -> plugin_name, array($this, 'display_plugin_setup_page'));
	}
	...
	public function display_plugin_setup_page() {
		...
		include_once( 'partials/smartarget-line-admin-display.php' );
	}
